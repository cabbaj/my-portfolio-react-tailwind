...
const Hero = () => {
  return (
    <section className="container flex flex-col items-center justify-center mt-8 bg-slate-950">
      <img
        src={Icon}
        alt="icon"
      ...
      <p className="max-w-3xl px-4 mt-4 muted-text">
        ...
        interfaces and improve <strong className="text-white">1%</strong> every
        day.
      </p>
